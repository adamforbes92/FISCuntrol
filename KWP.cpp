...
SENSOR KWP::getSensorData(byte k, byte a, byte b) {
  ...
  switch (k) {
    ...
    case 3:  v = 0.002 * a * b;           units = F("Degrees"); break;
    case 4:  v = abs(b - 127) * 0.01 * a;   units = F("ATDC"); break;
    case 5:  v = a * (b - 100) * 0.1;       units = F("deg C"); break;
    ...
    case 31: v = b / 2560 * a;            units = F("deg C"); break;
    ...
    case 70: v = (256 * a + b) * 0.192;      units = F("m/s2"); break;
    case 255: v = (1 * a / b) * 1;      units = F("FF"); break;
...
String KWP::getBlockDesc(uint8_t addr, int block) {
  ...
  //Label 06A-906-032-AUM.lbl
    ...
    switch (block) {
      ...
      case 20: blockDescs = F("Retard1,Retard2,Retard3,Retard4"); break; //case 20: blockDescs=F("Timing Retardation,Timing Retardation,Timing Retardation,Timing Retardation"); break;
      ...
      case 32: blockDescs = F("Trims (Idle),Trims (Partial)"); break;
